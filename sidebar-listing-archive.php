		...
		<?php else : ?>
			...
			<section class="widget-section">
				...
				<div class="widget">
					...
					<h3 class="widget-title"><?php _e( 'Listing Archive Sidebar', 'wpcasa-sylt' ); ?></h3>
					
					<p><?php printf( 'Display content here by activating widgets in the "%s" widget area on WP-Admin > Appearance > Widgets.', __( 'Listing Archive Sidebar', 'wpcasa-sylt' ) ); ?></p>
