...
<div class="listings-search-field listings-search-field-<?php echo esc_attr( $fields[$field]['type'] ); ?> listings-search-field-<?php echo esc_attr( $field ); ?> <?php echo esc_attr( $class ); ?>">
	...
	<?php foreach( $fields[$field]['data'] as $k => $v ) : ?>	
		...
		<input type="radio" id="<?php echo esc_attr( wpsight_get_query_var_by_detail( $field ) ); ?>[<?php echo esc_attr( $k ); ?>]" name="<?php echo esc_attr( wpsight_get_query_var_by_detail( $field ) ); ?>" value="<?php echo esc_attr( $k ); ?>"<?php checked( $k, sanitize_key( $field_value ) ); ?> data-default="<?php echo esc_attr( $data_default ); ?>"/> <?php echo esc_attr( $v ); ?>
		<label class="radio" for="<?php echo esc_attr( wpsight_get_query_var_by_detail( $field ) ); ?>[<?php echo esc_attr( $k ); ?>]"></label>
	<?php endforeach; ?>
