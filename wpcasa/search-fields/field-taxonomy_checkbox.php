...
<div class="listings-search-field listings-search-field-<?php echo esc_attr( $fields[$field]['type'] ); ?> listings-search-field-<?php echo esc_attr( $field ); ?> <?php echo esc_attr( $class ); ?>">
	...
	<?php foreach( get_terms( $fields[$field]['data']['taxonomy'], $checklist_args ) as $k => $v ) : ?>				
		...
		<input type="checkbox" id="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $v->term_id ); ?>]" name="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $v->term_id ); ?>]" value="<?php echo esc_attr( $v->slug ); ?>"<?php checked( $v->slug, $field_option_value ); ?>>
		<label class="checkbox" for="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $v->term_id ); ?>]"><?php echo esc_attr( $v->name ); ?></label>
