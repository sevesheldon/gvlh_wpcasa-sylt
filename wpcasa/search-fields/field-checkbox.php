...
<div class="listings-search-field listings-search-field-<?php echo esc_attr( $fields[$field]['type'] ); ?> listings-search-field-<?php echo esc_attr( $field ); ?> <?php echo esc_attr( $class ); ?>">
	...
	<?php foreach( $fields[$field]['data'] as $k => $v ) : ?>	
		...
		?>			
		<input type="checkbox" id="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $k ); ?>]" name="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $k ); ?>]" value="<?php echo esc_attr( $k ); ?>"<?php checked( $k, $field_option_value ); ?>>
		<label class="checkbox" for="<?php echo esc_attr( $field ); ?>[<?php echo esc_attr( $k ); ?>]"><?php echo esc_attr( $v ); ?></label>		
	<?php endforeach; ?>
